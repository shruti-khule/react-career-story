      ...
      <Section
        ...
        description={
          <div className="mobile-tight space-y-3 sm:space-y-4 [&_p]:text-[13px] sm:[&_p]:text-base">
            ...
            <p>
              I enjoy working on AI systems where LLMs are embedded into real backend workflows, not
              just prototypes.
            </p>
            <p className="mobile-hide">
              Currently, I’m focused on improving my system design skills and exploring multi-agent
              architectures for production use cases. Also learning German - slowly but consistently
              :)
            </p>
          </div>
        }
            ...
            <ul className="space-y-3 text-sm sm:space-y-4">
              <li>
                ...
                <p className="text-muted-foreground">
                  M.Sc. in Computer Science · 10/2022 – 03/2026
                </p>
